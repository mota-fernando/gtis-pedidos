...
class crepresentantes_list extends crepresentantes {
	...
	function __construct() {
		...
		$this->FilterOptions->TagClassName = "ewFilterOption frepresentanteslistsrch";
	...
	function SetupKeyValues($key) {
		...
		if (count($arrKeyFlds) >= 1) {
			$this->id_representantes->setFormValue($arrKeyFlds[0]);
			if (!is_numeric($this->id_representantes->FormValue))
				return FALSE;
		}
		return TRUE;
	}
	...
	function RenderListOptions() {
		...
		$oListOpt->Body = "<input type=\"checkbox\" name=\"key_m[]\" class=\"ewMultiSelect\" value=\"" . ew_HtmlEncode($this->id_representantes->CurrentValue) . "\" onclick=\"ew_ClickMultiCheckbox(event);\">";
	...
	function SetupOtherOptions() {
		...
		$item->Body = "<a class=\"ewSaveFilter\" data-form=\"frepresentanteslistsrch\" href=\"#\">" . $Language->Phrase("SaveCurrentFilter") . "</a>";
		$item->Visible = FALSE;
		$item = &$this->FilterOptions->Add("deletefilter");
		$item->Body = "<a class=\"ewDeleteFilter\" data-form=\"frepresentanteslistsrch\" href=\"#\">" . $Language->Phrase("DeleteFilter") . "</a>";
		$item->Visible = FALSE;
		...
		$options = &$this->OtherOptions;
			...
			foreach ($this->ListActions->Items as $listaction) {
				if ($listaction->Select == EW_ACTION_MULTIPLE) {
					...
					$item->Body = "<a class=\"ewAction ewListAction\" title=\"" . ew_HtmlEncode($caption) . "\" data-caption=\"" . ew_HtmlEncode($caption) . "\" href=\"\" onclick=\"ew_SubmitAction(event,jQuery.extend({f:document.frepresentanteslist}," . $listaction->ToJson(TRUE) . "));return false;\">" . $icon . "</a>";
	...
	function SetupExportOptions() {
		...
		$item->Body = "<a class=\"ewExportLink ewPrint\" title=\"" . ew_HtmlEncode($Language->Phrase("PrinterFriendlyText")) . "\" data-caption=\"" . ew_HtmlEncode($Language->Phrase("PrinterFriendlyText")) . "\" onclick=\"ew_Export(document.frepresentanteslist,'" . ew_CurrentPage() . "','print',false,true);\">" . $Language->Phrase("PrinterFriendly") . "</a>";
		$item->Visible = TRUE;

		// Export to Excel
		$item = &$this->ExportOptions->Add("excel");
		$item->Body = "<a class=\"ewExportLink ewExcel\" title=\"" . ew_HtmlEncode($Language->Phrase("ExportToExcelText")) . "\" data-caption=\"" . ew_HtmlEncode($Language->Phrase("ExportToExcelText")) . "\" onclick=\"ew_Export(document.frepresentanteslist,'" . ew_CurrentPage() . "','excel',false,true);\">" . $Language->Phrase("ExportToExcel") . "</a>";
		$item->Visible = TRUE;

		// Export to Word
		$item = &$this->ExportOptions->Add("word");
		$item->Body = "<a class=\"ewExportLink ewWord\" title=\"" . ew_HtmlEncode($Language->Phrase("ExportToWordText")) . "\" data-caption=\"" . ew_HtmlEncode($Language->Phrase("ExportToWordText")) . "\" onclick=\"ew_Export(document.frepresentanteslist,'" . ew_CurrentPage() . "','word',false,true);\">" . $Language->Phrase("ExportToWord") . "</a>";
		$item->Visible = FALSE;

		// Export to Html
		$item = &$this->ExportOptions->Add("html");
		$item->Body = "<a class=\"ewExportLink ewHtml\" title=\"" . ew_HtmlEncode($Language->Phrase("ExportToHtmlText")) . "\" data-caption=\"" . ew_HtmlEncode($Language->Phrase("ExportToHtmlText")) . "\" onclick=\"ew_Export(document.frepresentanteslist,'" . ew_CurrentPage() . "','html',false,true);\">" . $Language->Phrase("ExportToHtml") . "</a>";
		$item->Visible = FALSE;

		// Export to Xml
		$item = &$this->ExportOptions->Add("xml");
		$item->Body = "<a class=\"ewExportLink ewXml\" title=\"" . ew_HtmlEncode($Language->Phrase("ExportToXmlText")) . "\" data-caption=\"" . ew_HtmlEncode($Language->Phrase("ExportToXmlText")) . "\" onclick=\"ew_Export(document.frepresentanteslist,'" . ew_CurrentPage() . "','xml',false,true);\">" . $Language->Phrase("ExportToXml") . "</a>";
		$item->Visible = FALSE;

		// Export to Csv
		$item = &$this->ExportOptions->Add("csv");
		$item->Body = "<a class=\"ewExportLink ewCsv\" title=\"" . ew_HtmlEncode($Language->Phrase("ExportToCsvText")) . "\" data-caption=\"" . ew_HtmlEncode($Language->Phrase("ExportToCsvText")) . "\" onclick=\"ew_Export(document.frepresentanteslist,'" . ew_CurrentPage() . "','csv',false,true);\">" . $Language->Phrase("ExportToCsv") . "</a>";
		$item->Visible = FALSE;

		// Export to Pdf
		$item = &$this->ExportOptions->Add("pdf");
		$item->Body = "<a class=\"ewExportLink ewPdf\" title=\"" . ew_HtmlEncode($Language->Phrase("ExportToPDFText")) . "\" data-caption=\"" . ew_HtmlEncode($Language->Phrase("ExportToPDFText")) . "\" onclick=\"ew_Export(document.frepresentanteslist,'" . ew_CurrentPage() . "','pdf',false,true);\">" . $Language->Phrase("ExportToPDF") . "</a>";
		$item->Visible = FALSE;

		// Export to Email
		$item = &$this->ExportOptions->Add("email");
		$url = "";
		$item->Body = "<button id=\"emf_representantes\" class=\"ewExportLink ewEmail\" title=\"" . $Language->Phrase("ExportToEmailText") . "\" data-caption=\"" . $Language->Phrase("ExportToEmailText") . "\" onclick=\"ew_EmailDialogShow({lnk:'emf_representantes',hdr:ewLanguage.Phrase('ExportToEmailText'),f:document.frepresentanteslist,sel:true" . $url . "});\">" . $Language->Phrase("ExportToEmail") . "</button>";
		$item->Visible = FALSE;
...
var CurrentForm = frepresentanteslist = new ew_Form("frepresentanteslist", "list");
...
<?php if ($representantes->Export == "") { ?>
<div class="ewToolbar">
<?php if ($representantes_list->TotalRecs > 0 && $representantes_list->ExportOptions->Visible()) { ?>
<?php $representantes_list->ExportOptions->Render("body") ?>
<?php } ?>
<div class="clearfix"></div>
</div>
<?php } ?>
<?php
	$bSelectLimit = $representantes_list->UseSelectLimit;
	if ($bSelectLimit) {
		if ($representantes_list->TotalRecs <= 0)
			$representantes_list->TotalRecs = $representantes->ListRecordCount();
	} else {
		if (!$representantes_list->Recordset && ($representantes_list->Recordset = $representantes_list->LoadRecordset()))
	...
	if ($representantes->CurrentAction == "" && $representantes_list->TotalRecs == 0) {
		if ($representantes_list->SearchWhere == "0=101")
			$representantes_list->setWarningMessage($Language->Phrase("EnterSearchCriteria"));
		else
			$representantes_list->setWarningMessage($Language->Phrase("NoRecord"));
	}
...
<div id="gmp_representantes" class="<?php if (ew_IsResponsiveLayout()) { ?>table-responsive <?php } ?>ewGridMiddlePanel">
<?php if ($representantes_list->TotalRecs > 0 || $representantes->CurrentAction == "gridedit") { ?>
<table id="tbl_representanteslist" class="table ewTable">
<thead>
	<tr class="ewTableHeader">
<?php

// Header row
$representantes_list->RowType = EW_ROWTYPE_HEADER;
...
<?php if ($representantes->id_representantes->Visible) { // id_representantes ?>
	<?php if ($representantes->SortUrl($representantes->id_representantes) == "") { ?>
		<th data-name="id_representantes" class="<?php echo $representantes->id_representantes->HeaderCellClass() ?>"><div id="elh_representantes_id_representantes" class="representantes_id_representantes"><div class="ewTableHeaderCaption"><?php echo $representantes->id_representantes->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="id_representantes" class="<?php echo $representantes->id_representantes->HeaderCellClass() ?>"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $representantes->SortUrl($representantes->id_representantes) ?>',1);"><div id="elh_representantes_id_representantes" class="representantes_id_representantes">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $representantes->id_representantes->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($representantes->id_representantes->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($representantes->id_representantes->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
<?php if ($representantes->id_pessoa->Visible) { // id_pessoa ?>
	<?php if ($representantes->SortUrl($representantes->id_pessoa) == "") { ?>
		<th data-name="id_pessoa" class="<?php echo $representantes->id_pessoa->HeaderCellClass() ?>"><div id="elh_representantes_id_pessoa" class="representantes_id_pessoa"><div class="ewTableHeaderCaption"><?php echo $representantes->id_pessoa->FldCaption() ?></div></div></th>
	<?php } else { ?>
...
<span id="el<?php echo $representantes_list->RowCnt ?>_representantes_id_representantes" class="representantes_id_representantes">
...
<?php echo $representantes->id_representantes->ListViewValue() ?></span>
	...
	<?php } ?>
	<?php if ($representantes->id_pessoa->Visible) { // id_pessoa ?>
		<td data-name="id_pessoa"<?php echo $representantes->id_pessoa->CellAttributes() ?>>
...
<?php } ?>
<?php if ($representantes_list->TotalRecs == 0 && $representantes->CurrentAction == "") { // Show other options ?>
<div class="ewListOtherOptions">
<?php
	foreach ($representantes_list->OtherOptions as &$option) {
		$option->ButtonClass = "";
