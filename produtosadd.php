...
class cprodutos_add extends cprodutos {
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "produtosview.php")
	...
	function RenderRow() {
		...
		$this->ipi->ViewCustomAttributes = "";
			...
			$this->id_departamento_produto->EditValue = ew_HtmlEncode($this->id_departamento_produto->CurrentValue);
			...
			$this->id_marca_produto->EditValue = ew_HtmlEncode($this->id_marca_produto->CurrentValue);
	...
	function ValidateForm() {
		...
		if (!ew_CheckInteger($this->id_departamento_produto->FormValue)) {
			ew_AddMessage($gsFormError, $this->id_departamento_produto->FldErrMsg());
		}
		if (!ew_CheckInteger($this->id_marca_produto->FormValue)) {
			ew_AddMessage($gsFormError, $this->id_marca_produto->FldErrMsg());
		}
	...
	function AddRow($rsold = NULL) {
		...
		// data_adicionado
		$this->data_adicionado->SetDbValueDef($rsnew, ew_UnFormatDateTime($this->data_adicionado->CurrentValue, 0), NULL, FALSE);

		// hora_adicionado
		$this->hora_adicionado->SetDbValueDef($rsnew, $this->hora_adicionado->CurrentValue, NULL, FALSE);
...
fprodutosadd.Validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		$fobj.data("rowindex", infix);
			...
			elm = this.GetElements("x" + infix + "_id_departamento_produto");
			if (elm && !ew_CheckInteger(elm.value))
				return this.OnError(elm, "<?php echo ew_JsEncode2($produtos->id_departamento_produto->FldErrMsg()) ?>");
			elm = this.GetElements("x" + infix + "_id_marca_produto");
			if (elm && !ew_CheckInteger(elm.value))
				return this.OnError(elm, "<?php echo ew_JsEncode2($produtos->id_marca_produto->FldErrMsg()) ?>");
...
<input type="hidden" name="modal" value="<?php echo intval($produtos_add->IsModal) ?>">
<div class="ewAddDiv"><!-- page* -->
<?php if ($produtos->codigo_produto->Visible) { // codigo_produto ?>
	<div id="r_codigo_produto" class="form-group">
		<label id="elh_produtos_codigo_produto" for="x_codigo_produto" class="<?php echo $produtos_add->LeftColumnClass ?>"><?php echo $produtos->codigo_produto->FldCaption() ?></label>
		<div class="<?php echo $produtos_add->RightColumnClass ?>"><div<?php echo $produtos->codigo_produto->CellAttributes() ?>>
...
<?php if ($produtos->nome_produto->Visible) { // nome_produto ?>
	<div id="r_nome_produto" class="form-group">
		<label id="elh_produtos_nome_produto" for="x_nome_produto" class="<?php echo $produtos_add->LeftColumnClass ?>"><?php echo $produtos->nome_produto->FldCaption() ?></label>
		<div class="<?php echo $produtos_add->RightColumnClass ?>"><div<?php echo $produtos->nome_produto->CellAttributes() ?>>
...
<?php if ($produtos->modelo_produto->Visible) { // modelo_produto ?>
	<div id="r_modelo_produto" class="form-group">
		<label id="elh_produtos_modelo_produto" for="x_modelo_produto" class="<?php echo $produtos_add->LeftColumnClass ?>"><?php echo $produtos->modelo_produto->FldCaption() ?></label>
		<div class="<?php echo $produtos_add->RightColumnClass ?>"><div<?php echo $produtos->modelo_produto->CellAttributes() ?>>
...
<input type="text" data-table="produtos" data-field="x_id_departamento_produto" name="x_id_departamento_produto" id="x_id_departamento_produto" size="30" placeholder="<?php echo ew_HtmlEncode($produtos->id_departamento_produto->getPlaceHolder()) ?>" value="<?php echo $produtos->id_departamento_produto->EditValue ?>"<?php echo $produtos->id_departamento_produto->EditAttributes() ?>>
</span>
...
<?php if ($produtos->id_marca_produto->Visible) { // id_marca_produto ?>
	<div id="r_id_marca_produto" class="form-group">
		<label id="elh_produtos_id_marca_produto" for="x_id_marca_produto" class="<?php echo $produtos_add->LeftColumnClass ?>"><?php echo $produtos->id_marca_produto->FldCaption() ?></label>
		<div class="<?php echo $produtos_add->RightColumnClass ?>"><div<?php echo $produtos->id_marca_produto->CellAttributes() ?>>
<span id="el_produtos_id_marca_produto">
<input type="text" data-table="produtos" data-field="x_id_marca_produto" name="x_id_marca_produto" id="x_id_marca_produto" size="30" placeholder="<?php echo ew_HtmlEncode($produtos->id_marca_produto->getPlaceHolder()) ?>" value="<?php echo $produtos->id_marca_produto->EditValue ?>"<?php echo $produtos->id_marca_produto->EditAttributes() ?>>
</span>
...
<?php if ($produtos->unidade_medida_produto->Visible) { // unidade_medida_produto ?>
	<div id="r_unidade_medida_produto" class="form-group">
		<label id="elh_produtos_unidade_medida_produto" for="x_unidade_medida_produto" class="<?php echo $produtos_add->LeftColumnClass ?>"><?php echo $produtos->unidade_medida_produto->FldCaption() ?></label>
		<div class="<?php echo $produtos_add->RightColumnClass ?>"><div<?php echo $produtos->unidade_medida_produto->CellAttributes() ?>>
...
<?php if ($produtos->peso_produto->Visible) { // peso_produto ?>
	<div id="r_peso_produto" class="form-group">
		<label id="elh_produtos_peso_produto" for="x_peso_produto" class="<?php echo $produtos_add->LeftColumnClass ?>"><?php echo $produtos->peso_produto->FldCaption() ?></label>
		<div class="<?php echo $produtos_add->RightColumnClass ?>"><div<?php echo $produtos->peso_produto->CellAttributes() ?>>
...
<?php if ($produtos->data_adicionado->Visible) { // data_adicionado ?>
	<div id="r_data_adicionado" class="form-group">
		<label id="elh_produtos_data_adicionado" for="x_data_adicionado" class="<?php echo $produtos_add->LeftColumnClass ?>"><?php echo $produtos->data_adicionado->FldCaption() ?></label>
		<div class="<?php echo $produtos_add->RightColumnClass ?>"><div<?php echo $produtos->data_adicionado->CellAttributes() ?>>
...
<?php if ($produtos->hora_adicionado->Visible) { // hora_adicionado ?>
	<div id="r_hora_adicionado" class="form-group">
		<label id="elh_produtos_hora_adicionado" for="x_hora_adicionado" class="<?php echo $produtos_add->LeftColumnClass ?>"><?php echo $produtos->hora_adicionado->FldCaption() ?></label>
		<div class="<?php echo $produtos_add->RightColumnClass ?>"><div<?php echo $produtos->hora_adicionado->CellAttributes() ?>>
...
<?php if ($produtos->preco_produto->Visible) { // preco_produto ?>
	<div id="r_preco_produto" class="form-group">
		<label id="elh_produtos_preco_produto" for="x_preco_produto" class="<?php echo $produtos_add->LeftColumnClass ?>"><?php echo $produtos->preco_produto->FldCaption() ?></label>
		<div class="<?php echo $produtos_add->RightColumnClass ?>"><div<?php echo $produtos->preco_produto->CellAttributes() ?>>
...
<?php if ($produtos->descricao->Visible) { // descricao ?>
	<div id="r_descricao" class="form-group">
		<label id="elh_produtos_descricao" for="x_descricao" class="<?php echo $produtos_add->LeftColumnClass ?>"><?php echo $produtos->descricao->FldCaption() ?></label>
		<div class="<?php echo $produtos_add->RightColumnClass ?>"><div<?php echo $produtos->descricao->CellAttributes() ?>>
...
<?php if ($produtos->ipi->Visible) { // ipi ?>
	<div id="r_ipi" class="form-group">
		<label id="elh_produtos_ipi" for="x_ipi" class="<?php echo $produtos_add->LeftColumnClass ?>"><?php echo $produtos->ipi->FldCaption() ?></label>
		<div class="<?php echo $produtos_add->RightColumnClass ?>"><div<?php echo $produtos->ipi->CellAttributes() ?>>
...
<?php if (!$produtos_add->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $produtos_add->OffsetColumnClass ?>"><!-- buttons offset -->
