...
$tranportadora_add = NULL; // Initialize page object first

class ctranportadora_add extends ctranportadora {
	...
	// Page object name
	var $PageObjName = 'tranportadora_add';
	...
	function Page_Main() {
		...
		if (@$_POST["a_add"] <> "") {
			...
			if (@$_GET["id_transportadora"] != "") {
				...
				$this->setKey("id_transportadora", $this->id_transportadora->CurrentValue); // Set up key
			} else {
				$this->setKey("id_transportadora", ""); // Clear key
	...
	function LoadDefaultValues() {
		...
		$this->transportadora->CurrentValue = NULL;
		$this->transportadora->OldValue = $this->transportadora->CurrentValue;
		$this->id_empresa_transportadora->CurrentValue = NULL;
		$this->id_empresa_transportadora->OldValue = $this->id_empresa_transportadora->CurrentValue;
	}
	...
	function NewRow() {
		...
		$row['transportadora'] = $this->transportadora->CurrentValue;
		$row['id_empresa_transportadora'] = $this->id_empresa_transportadora->CurrentValue;
		return $row;
	}
	...
	function AddRow($rsold = NULL) {
		...
		// transportadora
		$this->transportadora->SetDbValueDef($rsnew, $this->transportadora->CurrentValue, NULL, FALSE);

		// id_empresa_transportadora
		$this->id_empresa_transportadora->SetDbValueDef($rsnew, $this->id_empresa_transportadora->CurrentValue, NULL, FALSE);
...
// Create page object
if (!isset($tranportadora_add)) $tranportadora_add = new ctranportadora_add();

// Page init
$tranportadora_add->Page_Init();

// Page main
$tranportadora_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$tranportadora_add->Page_Render();
?>
...
var CurrentForm = ftranportadoraadd = new ew_Form("ftranportadoraadd", "add");

// Validate form
ftranportadoraadd.Validate = function() {
...
ftranportadoraadd.Form_CustomValidate = 
...
ftranportadoraadd.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
ftranportadoraadd.Lists["x_id_empresa_transportadora"] = {"LinkField":"x_id_perfil","Ajax":true,"AutoFill":false,"DisplayFields":["x_razao_social","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"empresas"};
ftranportadoraadd.Lists["x_id_empresa_transportadora"].Data = "<?php echo $tranportadora_add->id_empresa_transportadora->LookupFilterQuery(FALSE, "add") ?>";
...
<?php $tranportadora_add->ShowPageHeader(); ?>
<?php
$tranportadora_add->ShowMessage();
?>
<form name="ftranportadoraadd" id="ftranportadoraadd" class="<?php echo $tranportadora_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($tranportadora_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $tranportadora_add->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="tranportadora">
<input type="hidden" name="a_add" id="a_add" value="A">
<input type="hidden" name="modal" value="<?php echo intval($tranportadora_add->IsModal) ?>">
<div class="ewAddDiv"><!-- page* -->
<?php if ($tranportadora->transportadora->Visible) { // transportadora ?>
	<div id="r_transportadora" class="form-group">
		<label id="elh_tranportadora_transportadora" for="x_transportadora" class="<?php echo $tranportadora_add->LeftColumnClass ?>"><?php echo $tranportadora->transportadora->FldCaption() ?></label>
		<div class="<?php echo $tranportadora_add->RightColumnClass ?>"><div<?php echo $tranportadora->transportadora->CellAttributes() ?>>
...
<?php if ($tranportadora->id_empresa_transportadora->Visible) { // id_empresa_transportadora ?>
	<div id="r_id_empresa_transportadora" class="form-group">
		<label id="elh_tranportadora_id_empresa_transportadora" for="x_id_empresa_transportadora" class="<?php echo $tranportadora_add->LeftColumnClass ?>"><?php echo $tranportadora->id_empresa_transportadora->FldCaption() ?></label>
		<div class="<?php echo $tranportadora_add->RightColumnClass ?>"><div<?php echo $tranportadora->id_empresa_transportadora->CellAttributes() ?>>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $tranportadora_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<script type="text/javascript">
ftranportadoraadd.Init();
</script>
<?php
$tranportadora_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$tranportadora_add->Page_Terminate();
?>
