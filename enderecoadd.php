	...
	function Page_Main() {
		...
		if (@$_POST["a_add"] <> "") {
			...
			if (@$_GET["id_endereco"] != "") {
				...
				$this->setKey("id_endereco", $this->id_endereco->CurrentValue); // Set up key
			} else {
				$this->setKey("id_endereco", ""); // Clear key
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "enderecoview.php")
...
fenderecoadd.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<input type="hidden" name="modal" value="<?php echo intval($endereco_add->IsModal) ?>">
<div class="ewAddDiv"><!-- page* -->
<?php if ($endereco->endereco->Visible) { // endereco ?>
	<div id="r_endereco" class="form-group">
		<label id="elh_endereco_endereco" for="x_endereco" class="<?php echo $endereco_add->LeftColumnClass ?>"><?php echo $endereco->endereco->FldCaption() ?></label>
		<div class="<?php echo $endereco_add->RightColumnClass ?>"><div<?php echo $endereco->endereco->CellAttributes() ?>>
...
<?php if ($endereco->bairro->Visible) { // bairro ?>
	<div id="r_bairro" class="form-group">
		<label id="elh_endereco_bairro" for="x_bairro" class="<?php echo $endereco_add->LeftColumnClass ?>"><?php echo $endereco->bairro->FldCaption() ?></label>
		<div class="<?php echo $endereco_add->RightColumnClass ?>"><div<?php echo $endereco->bairro->CellAttributes() ?>>
...
<?php if ($endereco->estado->Visible) { // estado ?>
	<div id="r_estado" class="form-group">
		<label id="elh_endereco_estado" for="x_estado" class="<?php echo $endereco_add->LeftColumnClass ?>"><?php echo $endereco->estado->FldCaption() ?></label>
		<div class="<?php echo $endereco_add->RightColumnClass ?>"><div<?php echo $endereco->estado->CellAttributes() ?>>
...
<?php if ($endereco->cidade->Visible) { // cidade ?>
	<div id="r_cidade" class="form-group">
		<label id="elh_endereco_cidade" for="x_cidade" class="<?php echo $endereco_add->LeftColumnClass ?>"><?php echo $endereco->cidade->FldCaption() ?></label>
		<div class="<?php echo $endereco_add->RightColumnClass ?>"><div<?php echo $endereco->cidade->CellAttributes() ?>>
...
<?php if ($endereco->cep->Visible) { // cep ?>
	<div id="r_cep" class="form-group">
		<label id="elh_endereco_cep" for="x_cep" class="<?php echo $endereco_add->LeftColumnClass ?>"><?php echo $endereco->cep->FldCaption() ?></label>
		<div class="<?php echo $endereco_add->RightColumnClass ?>"><div<?php echo $endereco->cep->CellAttributes() ?>>
