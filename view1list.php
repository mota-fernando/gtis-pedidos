...
class cview1_list extends cview1 {
	...
	function GetFilterList() {
		...
		$sFilterList = ew_Concat($sFilterList, $this->comissao->AdvancedSearch->ToJson(), ","); // Field comissao
		if ($this->BasicSearch->Keyword <> "") {
	...
	function RestoreFilterList() {
		...
		// Field comissao
		$this->comissao->AdvancedSearch->SearchValue = @$filter["x_comissao"];
		$this->comissao->AdvancedSearch->SearchOperator = @$filter["z_comissao"];
		$this->comissao->AdvancedSearch->SearchCondition = @$filter["v_comissao"];
		$this->comissao->AdvancedSearch->SearchValue2 = @$filter["y_comissao"];
		$this->comissao->AdvancedSearch->SearchOperator2 = @$filter["w_comissao"];
		$this->comissao->AdvancedSearch->Save();
...
fview1list.Lists["x_id_pessoa"] = {"LinkField":"x_id_pessoa","Ajax":true,"AutoFill":false,"DisplayFields":["x_nome_pessoa","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"pessoa_fisica"};
fview1list.Lists["x_id_pessoa"].Data = "<?php echo $view1_list->id_pessoa->LookupFilterQuery(FALSE, "list") ?>";
...
<?php if ($view1->id_pessoa->Visible) { // id_pessoa ?>
	<?php if ($view1->SortUrl($view1->id_pessoa) == "") { ?>
		<th data-name="id_pessoa" class="<?php echo $view1->id_pessoa->HeaderCellClass() ?>"><div id="elh_view1_id_pessoa" class="view1_id_pessoa"><div class="ewTableHeaderCaption"><?php echo $view1->id_pessoa->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="id_pessoa" class="<?php echo $view1->id_pessoa->HeaderCellClass() ?>"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $view1->SortUrl($view1->id_pessoa) ?>',1);"><div id="elh_view1_id_pessoa" class="view1_id_pessoa">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $view1->id_pessoa->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($view1->id_pessoa->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($view1->id_pessoa->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
<?php if ($view1->nome_pessoa->Visible) { // nome_pessoa ?>
	<?php if ($view1->SortUrl($view1->nome_pessoa) == "") { ?>
		<th data-name="nome_pessoa" class="<?php echo $view1->nome_pessoa->HeaderCellClass() ?>"><div id="elh_view1_nome_pessoa" class="view1_nome_pessoa"><div class="ewTableHeaderCaption"><?php echo $view1->nome_pessoa->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="nome_pessoa" class="<?php echo $view1->nome_pessoa->HeaderCellClass() ?>"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $view1->SortUrl($view1->nome_pessoa) ?>',1);"><div id="elh_view1_nome_pessoa" class="view1_nome_pessoa">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $view1->nome_pessoa->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($view1->nome_pessoa->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($view1->nome_pessoa->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
<?php if ($view1->sobrenome_pessoa->Visible) { // sobrenome_pessoa ?>
	<?php if ($view1->SortUrl($view1->sobrenome_pessoa) == "") { ?>
		<th data-name="sobrenome_pessoa" class="<?php echo $view1->sobrenome_pessoa->HeaderCellClass() ?>"><div id="elh_view1_sobrenome_pessoa" class="view1_sobrenome_pessoa"><div class="ewTableHeaderCaption"><?php echo $view1->sobrenome_pessoa->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="sobrenome_pessoa" class="<?php echo $view1->sobrenome_pessoa->HeaderCellClass() ?>"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $view1->SortUrl($view1->sobrenome_pessoa) ?>',1);"><div id="elh_view1_sobrenome_pessoa" class="view1_sobrenome_pessoa">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $view1->sobrenome_pessoa->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($view1->sobrenome_pessoa->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($view1->sobrenome_pessoa->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
<?php
...
?>
	<?php if ($view1->id_pessoa->Visible) { // id_pessoa ?>
		<td data-name="id_pessoa"<?php echo $view1->id_pessoa->CellAttributes() ?>>
<span id="el<?php echo $view1_list->RowCnt ?>_view1_id_pessoa" class="view1_id_pessoa">
<span<?php echo $view1->id_pessoa->ViewAttributes() ?>>
<?php echo $view1->id_pessoa->ListViewValue() ?></span>
</span>
</td>
	<?php } ?>
	<?php if ($view1->nome_pessoa->Visible) { // nome_pessoa ?>
		<td data-name="nome_pessoa"<?php echo $view1->nome_pessoa->CellAttributes() ?>>
<span id="el<?php echo $view1_list->RowCnt ?>_view1_nome_pessoa" class="view1_nome_pessoa">
<span<?php echo $view1->nome_pessoa->ViewAttributes() ?>>
<?php echo $view1->nome_pessoa->ListViewValue() ?></span>
</span>
</td>
	<?php } ?>
	<?php if ($view1->sobrenome_pessoa->Visible) { // sobrenome_pessoa ?>
		<td data-name="sobrenome_pessoa"<?php echo $view1->sobrenome_pessoa->CellAttributes() ?>>
<span id="el<?php echo $view1_list->RowCnt ?>_view1_sobrenome_pessoa" class="view1_sobrenome_pessoa">
<span<?php echo $view1->sobrenome_pessoa->ViewAttributes() ?>>
<?php echo $view1->sobrenome_pessoa->ListViewValue() ?></span>
</span>
</td>
	<?php } ?>
<?php
