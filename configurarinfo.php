...
class cconfigurar extends cTable {
	...
	function __construct() {
		...
		$this->TableVar = 'configurar';
		$this->TableName = 'configurar';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`configurar`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		$this->pedido_minimo->Sortable = TRUE; // Allow sort
		$this->pedido_minimo->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['pedido_minimo'] = &$this->pedido_minimo;

		// valor_minimo_parcela
		$this->valor_minimo_parcela = new cField('configurar', 'configurar', 'x_valor_minimo_parcela', 'valor_minimo_parcela', '`valor_minimo_parcela`', '`valor_minimo_parcela`', 4, -1, FALSE, '`valor_minimo_parcela`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->valor_minimo_parcela->Sortable = TRUE; // Allow sort
		$this->valor_minimo_parcela->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`configurar`";
	}
	...
	function GetModalCaption($pageName) {
		...
		elseif ($pageName == "configuraredit.php")
			return $Language->Phrase("Edit");
		elseif ($pageName == "configuraradd.php")
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("configurarview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("configurarview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "configuraradd.php?" . $this->UrlParm($parm);
		else
			$url = "configuraradd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("configuraredit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("configuraradd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("configurardelete.php", $this->UrlParm());
	}
	...
	function RenderEditRow() {
		...
		$this->pedido_minimo->EditValue = $this->pedido_minimo->CurrentValue;
		...
		$this->valor_minimo_parcela->EditValue = $this->valor_minimo_parcela->CurrentValue;
