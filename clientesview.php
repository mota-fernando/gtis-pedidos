...
class cclientes_view extends cclientes {
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			...
			} elseif (@$_POST["id_cliente"] <> "") {
				$this->id_cliente->setFormValue($_POST["id_cliente"]);
				$this->RecKey["id_cliente"] = $this->id_cliente->FormValue;
			} else {
...
var CurrentForm = fclientesview = new ew_Form("fclientesview", "view");
...
fclientesview.Lists["x_id"] = {"LinkField":"x_id_pessoa","Ajax":true,"AutoFill":false,"DisplayFields":["x_nome_pessoa","x_sobrenome_pessoa","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"pessoa_fisica"};
