...
$configurar_edit = NULL; // Initialize page object first

class cconfigurar_edit extends cconfigurar {
	...
	// Page object name
	var $PageObjName = 'configurar_edit';
	...
	function Page_Main() {
		...
		if (@$_POST["a_edit"] <> "") {
			...
			// Load key from Form
			if ($objForm->HasValue("x_id_configurar")) {
				$this->id_configurar->setFormValue($objForm->GetValue("x_id_configurar"));
			}
		} else {
	...
	function LoadFormValues() {
		...
		// Load from form
		global $objForm;
		if (!$this->id_configurar->FldIsDetailKey)
			$this->id_configurar->setFormValue($objForm->GetValue("x_id_configurar"));
	...
	function RestoreFormValues() {
		global $objForm;
		$this->id_configurar->CurrentValue = $this->id_configurar->FormValue;
	...
	function EditRow() {
		...
		if ($rs->EOF) {
			...
			// pedido_minimo
			$this->pedido_minimo->SetDbValueDef($rsnew, $this->pedido_minimo->CurrentValue, NULL, $this->pedido_minimo->ReadOnly);

			// valor_minimo_parcela
			$this->valor_minimo_parcela->SetDbValueDef($rsnew, $this->valor_minimo_parcela->CurrentValue, NULL, $this->valor_minimo_parcela->ReadOnly);
...
// Create page object
if (!isset($configurar_edit)) $configurar_edit = new cconfigurar_edit();

// Page init
$configurar_edit->Page_Init();

// Page main
$configurar_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$configurar_edit->Page_Render();
?>
...
var CurrentForm = fconfiguraredit = new ew_Form("fconfiguraredit", "edit");

// Validate form
fconfiguraredit.Validate = function() {
...
fconfiguraredit.Form_CustomValidate = 
...
fconfiguraredit.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fconfiguraredit.Lists["x_id_empresa"] = {"LinkField":"x_id_perfil","Ajax":true,"AutoFill":false,"DisplayFields":["x_razao_social","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"empresas"};
fconfiguraredit.Lists["x_id_empresa"].Data = "<?php echo $configurar_edit->id_empresa->LookupFilterQuery(FALSE, "edit") ?>";
...
<?php $configurar_edit->ShowPageHeader(); ?>
<?php
$configurar_edit->ShowMessage();
?>
<form name="fconfiguraredit" id="fconfiguraredit" class="<?php echo $configurar_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($configurar_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $configurar_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="configurar">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<input type="hidden" name="modal" value="<?php echo intval($configurar_edit->IsModal) ?>">
<div class="ewEditDiv"><!-- page* -->
<?php if ($configurar->id_configurar->Visible) { // id_configurar ?>
	<div id="r_id_configurar" class="form-group">
		<label id="elh_configurar_id_configurar" class="<?php echo $configurar_edit->LeftColumnClass ?>"><?php echo $configurar->id_configurar->FldCaption() ?></label>
		<div class="<?php echo $configurar_edit->RightColumnClass ?>"><div<?php echo $configurar->id_configurar->CellAttributes() ?>>
<span id="el_configurar_id_configurar">
<span<?php echo $configurar->id_configurar->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $configurar->id_configurar->EditValue ?></p></span>
</span>
<input type="hidden" data-table="configurar" data-field="x_id_configurar" name="x_id_configurar" id="x_id_configurar" value="<?php echo ew_HtmlEncode($configurar->id_configurar->CurrentValue) ?>">
<?php echo $configurar->id_configurar->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($configurar->pedido_minimo->Visible) { // pedido_minimo ?>
	<div id="r_pedido_minimo" class="form-group">
		<label id="elh_configurar_pedido_minimo" for="x_pedido_minimo" class="<?php echo $configurar_edit->LeftColumnClass ?>"><?php echo $configurar->pedido_minimo->FldCaption() ?></label>
		<div class="<?php echo $configurar_edit->RightColumnClass ?>"><div<?php echo $configurar->pedido_minimo->CellAttributes() ?>>
...
<?php if ($configurar->valor_minimo_parcela->Visible) { // valor_minimo_parcela ?>
	<div id="r_valor_minimo_parcela" class="form-group">
		<label id="elh_configurar_valor_minimo_parcela" for="x_valor_minimo_parcela" class="<?php echo $configurar_edit->LeftColumnClass ?>"><?php echo $configurar->valor_minimo_parcela->FldCaption() ?></label>
		<div class="<?php echo $configurar_edit->RightColumnClass ?>"><div<?php echo $configurar->valor_minimo_parcela->CellAttributes() ?>>
...
<?php if ($configurar->id_empresa->Visible) { // id_empresa ?>
	<div id="r_id_empresa" class="form-group">
		<label id="elh_configurar_id_empresa" for="x_id_empresa" class="<?php echo $configurar_edit->LeftColumnClass ?>"><?php echo $configurar->id_empresa->FldCaption() ?></label>
		<div class="<?php echo $configurar_edit->RightColumnClass ?>"><div<?php echo $configurar->id_empresa->CellAttributes() ?>>
...
<?php if (!$configurar_edit->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $configurar_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("SaveBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $configurar_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<script type="text/javascript">
fconfiguraredit.Init();
</script>
<?php
$configurar_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$configurar_edit->Page_Terminate();
?>
