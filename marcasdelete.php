	...
	function Page_Main() {
		...
		if ($this->CurrentAction == "I") { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->Page_Terminate("marcaslist.php"); // Return to list
			}
		}
	}
...
var CurrentForm = fmarcasdelete = new ew_Form("fmarcasdelete", "delete");
...
fmarcasdelete.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
?>
<form name="fmarcasdelete" id="fmarcasdelete" class="form-inline ewForm ewDeleteForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($marcas_delete->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $marcas_delete->Token ?>">
<?php } ?>
...
<?php if ($marcas->id_marca->Visible) { // id_marca ?>
		<th class="<?php echo $marcas->id_marca->HeaderCellClass() ?>"><span id="elh_marcas_id_marca" class="marcas_id_marca"><?php echo $marcas->id_marca->FldCaption() ?></span></th>
<?php } ?>
<?php if ($marcas->nome_marca->Visible) { // nome_marca ?>
		<th class="<?php echo $marcas->nome_marca->HeaderCellClass() ?>"><span id="elh_marcas_nome_marca" class="marcas_nome_marca"><?php echo $marcas->nome_marca->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
<?php if ($marcas->id_marca->Visible) { // id_marca ?>
		<td<?php echo $marcas->id_marca->CellAttributes() ?>>
<span id="el<?php echo $marcas_delete->RowCnt ?>_marcas_id_marca" class="marcas_id_marca">
...
<?php } ?>
<?php if ($marcas->nome_marca->Visible) { // nome_marca ?>
		<td<?php echo $marcas->nome_marca->CellAttributes() ?>>
<span id="el<?php echo $marcas_delete->RowCnt ?>_marcas_nome_marca" class="marcas_nome_marca">
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $marcas_delete->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
</div>
</form>
<script type="text/javascript">
fmarcasdelete.Init();
