...
<?php if ($representantes->comissao->Visible) { // comissao ?>
	<tr id="r_comissao">
		<td class="col-sm-2"><span id="elh_representantes_comissao"><?php echo $representantes->comissao->FldCaption() ?></span></td>
...
<?php echo $representantes->comissao->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
