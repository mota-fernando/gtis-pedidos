...
$representantes_addopt = NULL; // Initialize page object first

class crepresentantes_addopt extends crepresentantes {
	...
	// Page object name
	var $PageObjName = 'representantes_addopt';
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow()) { // Add successful
					$row = array();
					$row["x_id_representantes"] = $this->id_representantes->DbValue;
	...
	function LoadDefaultValues() {
		...
		$this->id_representantes->OldValue = $this->id_representantes->CurrentValue;
	...
	function NewRow() {
		...
		$row = array();
		$row['id_representantes'] = $this->id_representantes->CurrentValue;
...
// Create page object
if (!isset($representantes_addopt)) $representantes_addopt = new crepresentantes_addopt();

// Page init
$representantes_addopt->Page_Init();

// Page main
$representantes_addopt->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$representantes_addopt->Page_Render();
?>
<script type="text/javascript">

// Form object
var CurrentPageID = EW_PAGE_ID = "addopt";
var CurrentForm = frepresentantesaddopt = new ew_Form("frepresentantesaddopt", "addopt");

// Validate form
frepresentantesaddopt.Validate = function() {
...
frepresentantesaddopt.Form_CustomValidate = 
...
frepresentantesaddopt.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
frepresentantesaddopt.Lists["x_id_pessoa"] = {"LinkField":"x_id_pessoa","Ajax":true,"AutoFill":false,"DisplayFields":["x_nome_pessoa","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"pessoa_fisica"};
frepresentantesaddopt.Lists["x_id_pessoa"].Data = "<?php echo $representantes_addopt->id_pessoa->LookupFilterQuery(FALSE, "addopt") ?>";
...
<?php
$representantes_addopt->ShowMessage();
?>
<form name="frepresentantesaddopt" id="frepresentantesaddopt" class="ewForm form-horizontal" action="representantesaddopt.php" method="post">
<?php if ($representantes_addopt->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $representantes_addopt->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="representantes">
<input type="hidden" name="a_addopt" id="a_addopt" value="A">
<?php if ($representantes->id_pessoa->Visible) { // id_pessoa ?>
	<div class="form-group">
		<label class="col-sm-2 control-label ewLabel" for="x_id_pessoa"><?php echo $representantes->id_pessoa->FldCaption() ?></label>
		<div class="col-sm-10">
...
<?php if ($representantes->comissao->Visible) { // comissao ?>
	<div class="form-group">
		<label class="col-sm-2 control-label ewLabel" for="x_comissao"><?php echo $representantes->comissao->FldCaption() ?></label>
		<div class="col-sm-10">
...
<?php
$representantes_addopt->Page_Terminate();
?>
