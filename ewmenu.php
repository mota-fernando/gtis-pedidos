...
$RootMenu->AddMenuItem(21, "mci_Cadastro", $Language->MenuPhrase("21", "MenuText"), "", -1, "", TRUE, FALSE, TRUE, "");
$RootMenu->AddMenuItem(1, "mi_clientes", $Language->MenuPhrase("1", "MenuText"), "clienteslist.php", 21, "", TRUE, FALSE, FALSE, "fa-user");
