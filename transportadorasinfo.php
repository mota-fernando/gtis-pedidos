...
//
// Table class for transportadoras
//
class ctransportadoras extends cTable {
	...
	function __construct() {
		...
		$this->TableVar = 'transportadoras';
		$this->TableName = 'transportadoras';
		$this->TableType = 'VIEW';

		// Update Table
		$this->UpdateTable = "`transportadoras`";
		$this->DBID = 'DB';
		...
		$this->id_empresa_transportadora = new cField('transportadoras', 'transportadoras', 'x_id_empresa_transportadora', 'id_empresa_transportadora', '`id_empresa_transportadora`', '`id_empresa_transportadora`', 3, -1, FALSE, '`id_empresa_transportadora`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// razao_social
		$this->razao_social = new cField('transportadoras', 'transportadoras', 'x_razao_social', 'razao_social', '`razao_social`', '`razao_social`', 200, -1, FALSE, '`razao_social`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`transportadoras`";
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "transportadoraslist.php";
		}
	}
	...
	function GetModalCaption($pageName) {
		global $Language;
		if ($pageName == "transportadorasview.php")
			return $Language->Phrase("View");
		elseif ($pageName == "transportadorasedit.php")
			return $Language->Phrase("Edit");
		elseif ($pageName == "transportadorasadd.php")
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("transportadorasview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("transportadorasview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "transportadorasadd.php?" . $this->UrlParm($parm);
		else
			$url = "transportadorasadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("transportadorasedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("transportadorasadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("transportadorasdelete.php", $this->UrlParm());
	}
