...
class cview1 extends cTable {
	...
	function __construct() {
		...
		// id_pessoa
		$this->id_pessoa = new cField('view1', 'view1', 'x_id_pessoa', 'id_pessoa', '`id_pessoa`', '`id_pessoa`', 3, -1, FALSE, '`EV__id_pessoa`', TRUE, TRUE, TRUE, 'FORMATTED TEXT', 'SELECT');
		...
		// nome_pessoa
		$this->nome_pessoa = new cField('view1', 'view1', 'x_nome_pessoa', 'nome_pessoa', '`nome_pessoa`', '`nome_pessoa`', 200, -1, FALSE, '`nome_pessoa`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->nome_pessoa->Sortable = TRUE; // Allow sort
		$this->fields['nome_pessoa'] = &$this->nome_pessoa;

		// sobrenome_pessoa
		$this->sobrenome_pessoa = new cField('view1', 'view1', 'x_sobrenome_pessoa', 'sobrenome_pessoa', '`sobrenome_pessoa`', '`sobrenome_pessoa`', 200, -1, FALSE, '`sobrenome_pessoa`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->sobrenome_pessoa->Sortable = TRUE; // Allow sort
		$this->fields['sobrenome_pessoa'] = &$this->sobrenome_pessoa;

		// comissao
		$this->comissao = new cField('view1', 'view1', 'x_comissao', 'comissao', '`comissao`', '`comissao`', 3, -1, FALSE, '`comissao`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlSelectList() { // Select for List page
		$select = "";
		$select = "SELECT * FROM (" .
			"SELECT *, (SELECT `nome_pessoa` FROM `pessoa_fisica` `EW_TMP_LOOKUPTABLE` WHERE `EW_TMP_LOOKUPTABLE`.`id_pessoa` = `view1`.`id_pessoa` LIMIT 1) AS `EV__id_pessoa` FROM `view1`" .
			") `EW_TMP_TABLE`";
