...
$tranportadora_addopt = NULL; // Initialize page object first

class ctranportadora_addopt extends ctranportadora {
	...
	// Page object name
	var $PageObjName = 'tranportadora_addopt';
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow()) { // Add successful
					$row = array();
					$row["x_id_transportadora"] = $this->id_transportadora->DbValue;
					$row["x_transportadora"] = ew_ConvertToUtf8($this->transportadora->DbValue);
					$row["x_id_empresa_transportadora"] = $this->id_empresa_transportadora->DbValue;
					if (!EW_DEBUG_ENABLED && ob_get_length())
						ob_end_clean();
	...
	function LoadFormValues() {
		...
		if (!$this->transportadora->FldIsDetailKey) {
			$this->transportadora->setFormValue(ew_ConvertFromUtf8($objForm->GetValue("x_transportadora")));
		}
		if (!$this->id_empresa_transportadora->FldIsDetailKey) {
			$this->id_empresa_transportadora->setFormValue(ew_ConvertFromUtf8($objForm->GetValue("x_id_empresa_transportadora")));
		}
	}
	...
	function RestoreFormValues() {
		global $objForm;
		$this->transportadora->CurrentValue = ew_ConvertToUtf8($this->transportadora->FormValue);
		$this->id_empresa_transportadora->CurrentValue = ew_ConvertToUtf8($this->id_empresa_transportadora->FormValue);
	}
...
// Create page object
if (!isset($tranportadora_addopt)) $tranportadora_addopt = new ctranportadora_addopt();

// Page init
$tranportadora_addopt->Page_Init();

// Page main
$tranportadora_addopt->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$tranportadora_addopt->Page_Render();
?>
<script type="text/javascript">

// Form object
var CurrentPageID = EW_PAGE_ID = "addopt";
var CurrentForm = ftranportadoraaddopt = new ew_Form("ftranportadoraaddopt", "addopt");

// Validate form
ftranportadoraaddopt.Validate = function() {
...
ftranportadoraaddopt.Form_CustomValidate = 
...
ftranportadoraaddopt.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
ftranportadoraaddopt.Lists["x_id_empresa_transportadora"] = {"LinkField":"x_id_perfil","Ajax":true,"AutoFill":false,"DisplayFields":["x_razao_social","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"empresas"};
ftranportadoraaddopt.Lists["x_id_empresa_transportadora"].Data = "<?php echo $tranportadora_addopt->id_empresa_transportadora->LookupFilterQuery(FALSE, "addopt") ?>";
...
<?php
$tranportadora_addopt->ShowMessage();
?>
<form name="ftranportadoraaddopt" id="ftranportadoraaddopt" class="ewForm form-horizontal" action="tranportadoraaddopt.php" method="post">
<?php if ($tranportadora_addopt->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $tranportadora_addopt->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="tranportadora">
<input type="hidden" name="a_addopt" id="a_addopt" value="A">
<?php if ($tranportadora->transportadora->Visible) { // transportadora ?>
	<div class="form-group">
		<label class="col-sm-2 control-label ewLabel" for="x_transportadora"><?php echo $tranportadora->transportadora->FldCaption() ?></label>
		<div class="col-sm-10">
...
<?php if ($tranportadora->id_empresa_transportadora->Visible) { // id_empresa_transportadora ?>
	<div class="form-group">
		<label class="col-sm-2 control-label ewLabel" for="x_id_empresa_transportadora"><?php echo $tranportadora->id_empresa_transportadora->FldCaption() ?></label>
		<div class="col-sm-10">
...
<?php
$tranportadora_addopt->Page_Terminate();
?>
