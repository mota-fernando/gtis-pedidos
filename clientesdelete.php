	...
	function Page_Main() {
		...
		if ($this->CurrentAction == "I") { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->Page_Terminate("clienteslist.php"); // Return to list
			}
		}
	}
...
var CurrentForm = fclientesdelete = new ew_Form("fclientesdelete", "delete");
...
fclientesdelete.Lists["x_id"] = {"LinkField":"x_id_pessoa","Ajax":true,"AutoFill":false,"DisplayFields":["x_nome_pessoa","x_sobrenome_pessoa","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"pessoa_fisica"};
fclientesdelete.Lists["x_id"].Data = "<?php echo $clientes_delete->id->LookupFilterQuery(FALSE, "delete") ?>";
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $clientes_delete->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
</div>
</form>
<script type="text/javascript">
