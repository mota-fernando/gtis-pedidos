...
fpessoa_fisicaedit.Lists["x_id_endereco"] = {"LinkField":"x_id_endereco","Ajax":true,"AutoFill":false,"DisplayFields":["x_endereco","x_bairro","x_estado","x_cidade"],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"endereco"};
fpessoa_fisicaedit.Lists["x_id_endereco"].Data = "<?php echo $pessoa_fisica_edit->id_endereco->LookupFilterQuery(FALSE, "edit") ?>";
fpessoa_fisicaedit.Lists["x_id_empresa"] = {"LinkField":"x_id_perfil","Ajax":true,"AutoFill":false,"DisplayFields":["x_razao_social","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"empresas"};
fpessoa_fisicaedit.Lists["x_id_empresa"].Data = "<?php echo $pessoa_fisica_edit->id_empresa->LookupFilterQuery(FALSE, "edit") ?>";
fpessoa_fisicaedit.AutoSuggests["x_id_empresa"] = <?php echo json_encode(array("data" => "ajax=autosuggest&" . $pessoa_fisica_edit->id_empresa->LookupFilterQuery(TRUE, "edit"))) ?>;
...
<?php if ($pessoa_fisica->id_empresa->Visible) { // id_empresa ?>
	<div id="r_id_empresa" class="form-group">
		<label id="elh_pessoa_fisica_id_empresa" class="<?php echo $pessoa_fisica_edit->LeftColumnClass ?>"><?php echo $pessoa_fisica->id_empresa->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $pessoa_fisica_edit->RightColumnClass ?>"><div<?php echo $pessoa_fisica->id_empresa->CellAttributes() ?>>
...
<script type="text/javascript">
fpessoa_fisicaedit.CreateAutoSuggest({"id":"x_id_empresa","forceSelect":false});
</script>
