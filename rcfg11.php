...
define("EWR_PROJECT_ID", "{3346984C-52AD-427D-8358-EC1897ABFA49}", TRUE); // Project ID
define("EWR_PROJECT_NAME", "pedidos", TRUE); // Project Name
...
$EWR_CONN["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "", "db" => "pedidos", "qs" => "`", "qe" => "`");
...
define("EWR_RANDOM_KEY", 'De9alBtp42fg78w5', TRUE); // Random key for encryption
define("EWR_PROJECT_STYLESHEET_FILENAME", "phprptcss/pedidos.css", TRUE); // Project stylesheet file name
...
define("EWR_TABLE_PREFIX", "{3346984C-52AD-427D-8358-EC1897ABFA49}", TRUE);
