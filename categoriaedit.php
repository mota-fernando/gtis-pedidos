...
$categoria_edit = NULL; // Initialize page object first

class ccategoria_edit extends ccategoria {
	...
	function Page_Main() {
		...
		if (@$_POST["a_edit"] <> "") {
			...
			// Load key from Form
			if ($objForm->HasValue("x_id_categoria")) {
...
// Create page object
if (!isset($categoria_edit)) $categoria_edit = new ccategoria_edit();
...
var CurrentForm = fcategoriaedit = new ew_Form("fcategoriaedit", "edit");

// Validate form
fcategoriaedit.Validate = function() {
...
fcategoriaedit.Form_CustomValidate = 
...
fcategoriaedit.Lists["x_id_pai"] = {"LinkField":"x_id_categoria","Ajax":true,"AutoFill":false,"DisplayFields":["x_categoria","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"categoria"};
...
?>
<form name="fcategoriaedit" id="fcategoriaedit" class="<?php echo $categoria_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($categoria_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $categoria_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="categoria">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<input type="hidden" name="modal" value="<?php echo intval($categoria_edit->IsModal) ?>">
<div class="ewEditDiv"><!-- page* -->
<?php if ($categoria->id_categoria->Visible) { // id_categoria ?>
	<div id="r_id_categoria" class="form-group">
		<label id="elh_categoria_id_categoria" class="<?php echo $categoria_edit->LeftColumnClass ?>"><?php echo $categoria->id_categoria->FldCaption() ?></label>
		<div class="<?php echo $categoria_edit->RightColumnClass ?>"><div<?php echo $categoria->id_categoria->CellAttributes() ?>>
<span id="el_categoria_id_categoria">
<span<?php echo $categoria->id_categoria->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $categoria->id_categoria->EditValue ?></p></span>
</span>
<input type="hidden" data-table="categoria" data-field="x_id_categoria" name="x_id_categoria" id="x_id_categoria" value="<?php echo ew_HtmlEncode($categoria->id_categoria->CurrentValue) ?>">
<?php echo $categoria->id_categoria->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($categoria->id_pai->Visible) { // id_pai ?>
	<div id="r_id_pai" class="form-group">
		<label id="elh_categoria_id_pai" for="x_id_pai" class="<?php echo $categoria_edit->LeftColumnClass ?>"><?php echo $categoria->id_pai->FldCaption() ?></label>
...
<?php if ($categoria->categoria->Visible) { // categoria ?>
	<div id="r_categoria" class="form-group">
		<label id="elh_categoria_categoria" for="x_categoria" class="<?php echo $categoria_edit->LeftColumnClass ?>"><?php echo $categoria->categoria->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $categoria_edit->RightColumnClass ?>"><div<?php echo $categoria->categoria->CellAttributes() ?>>
...
<?php echo $categoria->categoria->CustomMsg ?></div></div>
	</div>
<?php } ?>
</div><!-- /page* -->
<?php if (!$categoria_edit->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $categoria_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("SaveBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $categoria_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
